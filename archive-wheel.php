	...
	<div id="primary" class="content-area">
		...
		<div class="filters finish-filters">
			<div class="filter-group">
				<label for="brand_options">Collection</label>
			...
			<?php if ( isset( $_GET['collection'] ) && $_GET['collection'] == 'savini-forged' ) : ?>
			<div class="filter-group">
				<label for="config_options">Configuration</label>
				<select class="select" id="config" name="config_options" id="config_options" data-filter="config">
					<option value="all">All Configurations</option>
					<?php 
							$_config_terms = get_terms( 'wheel_configurations', array( 'hide_empty' => false ) );

							foreach ($_config_terms as $term) : 
