...
if( function_exists('acf_add_local_field_group') ):
	...
	acf_add_local_field_group(array(
		'key' => 'group_5cc133e170970',
		'title' => 'Finish Custom Fields',
		'fields' => array(
			array(
				'key' => 'field_5cc133eda3990',
				'label' => 'Wheel',
				'name' => 'finish_wheel',
				'type' => 'post_object',
				'instructions' => '',
	...
	acf_add_local_field_group(array(
		'key' => 'group_5cc12edc237e0',
		'title' => 'Savini Forged Custom Fields',
		'fields' => array(
			array(
				'key' => 'field_5cc12ee54ae02',
				'label' => 'Wheel Parent',
				'name' => 'wheel_parent',
				'type' => 'post_object',
				'instructions' => '',
				...
				'taxonomy' => array(
					0 => 'wheel_collections:savini-forged',
				),
				'allow_null' => 1,
				'multiple' => 0,
				'return_format' => 'id',
		...
		'location' => array(
			array(
				...
				array(
					'param' => 'post_taxonomy',
					'operator' => '==',
					'value' => 'wheel_collections:savini-forged',
				),
			),
		),
		'menu_order' => 0,
	...
	acf_add_local_field_group(array(
		'key' => 'group_5cac12e93afa6',
		'title' => 'Vehicle Custom Fields',
		'fields' => array(
			array(
				'key' => 'field_5cac12f29de22',
				'label' => 'Collection',
	...
	acf_add_local_field_group(array(
		'key' => 'group_5c5620c6ee558',
		'title' => 'Wheel Collection Custom Fields',
		'fields' => array(
			array(
				'key' => 'field_5c5620db87c51',
				'label' => 'Order',
	...
	acf_add_local_field_group(array(
		'key' => 'group_5c5ff4fd1dd99',
		'title' => 'Wheel Configuration Custom Fields',
		'fields' => array(
			array(
				'key' => 'field_5c5ff506ed5d0',
				'label' => 'Wheel Collection',
			...
			array(
				'key' => 'field_5c5ffe34d7366',
				'label' => 'Logo',
				'name' => 'configuration_logo',
				'type' => 'image',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5c600d83054f6',
				'label' => 'Background Image',
				'name' => 'configuration_bg__image',
				'type' => 'image',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5c5ffe86d7369',
				'label' => 'Availability',
				'name' => 'configuration_availability',
				'type' => 'select',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
			...
			array(
				'key' => 'field_5ccf5277a7ca7',
				'label' => 'Abbreviation',
				'name' => 'configuration_abbreviation',
				'type' => 'text',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
	...
	acf_add_local_field_group(array(
		'key' => 'group_5c60f8cedda29',
		'title' => 'Wheel Custom Fields',
		'fields' => array(
			array(
				'key' => 'field_5c610bcf7f901',
				'label' => 'New',
				'name' => 'wheel_new',
				'type' => 'true_false',
				'instructions' => '',
			...
			array(
				'key' => 'field_5cc12f613fe53',
				'label' => 'Construction',
				'name' => 'wheel_construction',
				'type' => 'text',
				'instructions' => '',
				'required' => 0,
				'conditional_logic' => 0,
